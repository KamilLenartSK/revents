...
import {asyncActionError, asyncActionStart, asyncActionEnd} from '../features/async/asyncActions'
...
export const uploadProfileImage = (file, fileName) => async(dispatch, getState, {getFirebase, getFirestore}) => {
    ...
    try {
        //upload file get url of the image get userDoc check if user
...
export const goingToEvent = event => async(dyspatch, getState, {getFirestore, getFirebase}) => {
    const firestore = getFirestore();
    const firebase = getFirebase();
    const user = firebase
        .auth()
    ...
    try {
        ...
        toastr.success('Success', 'You are going to the event')
    } catch (error) {
        console.log(error);
...
export const cancelGoingToEvent = event => async(dyspatch, getState, {getFirestore, getFirebase}) => {
    const firestore = getFirestore();
    const firebase = getFirebase();
    const user = firebase
        .auth()
